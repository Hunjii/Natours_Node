...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHVuamkiLCJhIjoiY2s5YXQ2NnAyMGN5aTNnbnkyZjhzZW1zaiJ9.M0tlkiQIlgrd9EwDoqDyAQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updatePassword' : '/api/v1/users/updateByUser';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var bookApartment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(apartmentId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(apartmentId));
  ...
  return function bookApartment(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookApartment = bookApartment;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, name, password, passwordConfirm, role) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, apartmentId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/apartments/".concat(apartmentId, "/reviews"),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'review successfully!');
              window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"create.js":[function(require,module,exports) {
"use strict";
...
var create = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(form) {
    var address, geolocation, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            address = form.get('location[address]');
            _context.next = 4;
            return (0, _axios.default)("https://api.opencagedata.com/geocode/v1/json?q=".concat(address, "&key=d9ccb983687d44d784086367f33bd1de"));

          case 4:
            geolocation = _context.sent;
            form.append('location[coordinates][]', geolocation.data.results[0].geometry.lng);
            form.append('location[coordinates][]', geolocation.data.results[0].geometry.lat);
            _context.next = 9;
            return (0, _axios.default)({
              method: 'POST',
              url: '/api/v1/apartments',
          ...
          case 9:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'create apartment successfully!');
              window.setTimeout(function () {
                location.assign('/my-apartments');
              }, 2000);
            }
...
var menuBar = document.querySelectorAll('.side-nav li');
...
var createForm = document.getElementById('form-create'); //const createReviewBtn = document.getElementById('btn-create-review');
// DELEGATION

if (mapBox) {
  var location = JSON.parse(mapBox.dataset.location);
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    var typeRadio = document.querySelector('input[name="typeUser"]:checked');
    e.preventDefault();
    var email = document.getElementById('email').value;
    var name = document.getElementById('name').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password-confirm').value;
    var role = typeRadio.value;
    (0, _signup.signup)(email, name, password, passwordConfirm, role);
  });
}
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    (0, _stripe.bookApartment)(roomId);
  });
}

if (menuBar) {
  var resetClass = function resetClass() {
    menuBar.forEach(function (el) {
      return el.classList.remove('side-nav--active');
    });
  };
...
if (reviewBtn) {
  ...
  reviewForm.addEventListener('submit', function (e) {
    ...
    var apartmentId = e.target.dataset.apartmentId;
    (0, _review.createReview)(review, rating, apartmentId);
  });
}
...
if (createForm) {
  createForm.addEventListener('submit', function (e) {
    ...
    form.append('countRoom[bathroom]', document.getElementById('bathroom').value);
    form.append('countRoom[bed]', document.getElementById('bed').value);
    form.append('price[priceCommon]', document.getElementById('priceCommon').value);
    form.append('price[priceWeekend]', document.getElementById('priceWeekend').value);
    form.append('price[priceDiscount]', document.getElementById('priceDiscount').value);
    form.append('typeAparment', document.getElementById('typeAparment').options[document.getElementById('typeAparment').selectedIndex].value);
    form.append('typeRoom', document.getElementById('typeRoom').options[document.getElementById('typeRoom').selectedIndex].value);
    ...
    form.append('location[description]', document.getElementById('location').value);
    form.append('location[address]', document.getElementById('address').value);
    var userId = e.target.dataset.userId;
    form.append('host', userId); // const name = document.getElementById('name').value;
